...
@Component({
  selector: 'app-materiallistuploadfilter',
  templateUrl: './materialListUploadFilter.component.html',
  styleUrls: ['./materialListUploadFilter.component.css']
})
export class MaterialListUploadFilterComponent implements OnInit {
  constructor(
    ...
    applyFilter(form: NgForm) {
      if (this.buildingMode) {
        if (this.filterService.buildingID === null) {
          ...
          this.router.navigate(['/admin/materialList/upload']);
        }
      }
    }
